...
// 電卓ディスプレイへの参照
const displayResult = document.getElementById("display-result") as HTMLInputElement;
const displayProcess = document.getElementById("display-process") as HTMLInputElement;
...
// 括弧を入力したときの処理
function handleParentheses(value: string): void {
    fullExpression += value;
    displayProcess.value = fullExpression; // 式全体を表示
}
